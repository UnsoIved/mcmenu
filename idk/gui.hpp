...
namespace ui
{
	...
	void tab_3(ImFont* font)
	{
		...
		ImGui::PushStyleColor(ImGuiCol_Border, ImColor(63, 63, 63));
		ImGui::PushStyleColor(ImGuiCol_CheckMark, ImColor(102, 153, 255));
		ImGui::PushStyleColor(ImGuiCol_SliderGrab, ImColor(102, 153, 255));
		ImGui::PushStyleColor(ImGuiCol_SliderGrabActive, ImColor(93, 153, 255));
		ImGui::BeginChild(xorstr("##tab2"), ImVec2(350, 250), true, ImGuiWindowFlags_NoScrollbar);
		{
			...
			
			{
				...
				if (ImGui::IsItemHovered())
					ImGui::SetTooltip(xorstr("put your minecraft window name\n\nexample: lunar, badlion etc")); 
                ImGui::SpacingInt(169);
                ImGui::Text("dev: unsolving");
	...
	namespace ac
	{
		void tab_2( ImFont *font )
		{
            ...
            ImGui::PushStyleColor(ImGuiCol_CheckMark, ImColor(102, 153, 255));
            ImGui::PushStyleColor(ImGuiCol_SliderGrab, ImColor(102, 153, 255));
            ImGui::PushStyleColor(ImGuiCol_SliderGrabActive, ImColor(100, 153, 255));
			ImGui::BeginChild( xorstr( "##tab2" ), ImVec2( 350, 250 ), true, ImGuiWindowFlags_NoScrollbar );
			{
				ImGui::SpacingInt( 5 );
				ImGui::SameLine( 15.f );
				ImGui::TextColored( ImColor( 255, 255, 255 ), xorstr( "autolicker" ) );
				ImGui::SpacingInt( 10 );
				...
				if (ImGui::IsItemHovered())
					       ImGui::SetTooltip(xorstr("makes ur arms longer u fucker"));
				ImGui::SpacingInt(5);
